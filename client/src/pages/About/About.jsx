...
const About = () => {
    return (
        ...
        <div >
            <h3 className="font-bold text-center mt-20 text-white text-3xl mb-12">About us</h3>
            ...
            <div className="max-w-screen-xl mx-auto py-8 px-4 lg:py-16 lg:px-6">
                ...
                <div className="flex flex-col md:flex-row">
                    <div className="mr-0 md:mr-8 mb-6 md:mb-0">
                        <img className="w-60 h-60 md:w-full mx-auto" src="pixel.PNG" alt="Pixel Cinemas" />

                    </div>

                    <div className="flex-1 flex flex-col sm:flex-row flex-wrap -mb-4 -mx-2">
                        <div className="w-full sm:w-1/2 mb-4 px-2 ">
                            <div className="h-full py-4 px-6 border border-teal-500 border-t-0 border-l-0 rounded-br-xl">
